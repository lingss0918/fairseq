...
@dataclass
class Decoar3Config(FairseqDataclass):
    ...
    labels: int = field(
        default=72,
        metadata={"help": "the number of labels predicting"},
    )


@register_model("decoar3", dataclass=Decoar3Config)
class Decoar3Model(BaseFairseqModel):
    def __init__(self, cfg: Decoar3Config):
        super().__init__()
        self.cfg = cfg
        self.embed = 240
        ...
        self.final_proj = nn.Linear(cfg.encoder_embed_dim, cfg.labels)
    ...
    @classmethod
    def build_model(cls, cfg: Decoar3Config, task=None):
    ...
    def forward(
        ...
        result = {
            "logits": x, "padding_mask": padding_mask, "mask_indices": mask_indices,
        }
    ...
    def get_targets(self, net_output, labels):
        return labels[net_output['mask_indices']]
